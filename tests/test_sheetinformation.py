...
class TestSheetInformation:
    ...
    def test_get__no_attr(self):
        ...
        with pytest.raises(AttributeError):
            t.get(
                "no_attr"
            ), "This should have thrown an AttributeError as the attribute does not exist"
    ...
    def test_is_proper_sanctioned_date__default(self):
        ...
        assert (
            t.sanctioned_date_is_valid()
        ), "This should return True by default as the given_sanctioned_date is not set"
    ...
    def test_is_proper_sanctioned_date__false(self):
        ...
        assert (
            t.sanctioned_date_is_valid() == False
        ), "Date string '23/13/01' should not be valid"
    ...
    def test_callings_defined__true(self):
        t = SheetInformation(
            game="scion", callings=["calling1", "calling2", "calling3"]
        )
